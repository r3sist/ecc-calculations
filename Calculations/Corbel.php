...
Class Corbel extends \Ecc
{
    ...
    public function calc(object $f3, object $blc, object $ec): void
    {
        ...
        $blc->h2('Hosszvas lehorgonyzása');
        $blc->txt('Konzol szabad vég felé eső hurkos lehorgonyzáshoz $a_(min) = '.$f3->_aMin.' [mm]$ konzolmélység alkalmazása szükséges! Pillér felőli lehorgonyzás számítása:');
